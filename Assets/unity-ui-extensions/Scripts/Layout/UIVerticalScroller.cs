        ...
        public void Update()
        {
            ...
            for (var i = 0; i < _arrayOfElements.Length; i++)
            {
                ...
                if (minDistance == distance[i])
                {
                    ...
                    //добавлено
                    _arrayOfElements[i].transform.Find("Text").GetComponent<TMP_Text>().color = new Color32(144, 96, 255, 255);
                    result = _arrayOfElements[i].GetComponentInChildren<TMP_Text>().text;
                }
                else
                {  //добавлено
                    _arrayOfElements[i].transform.Find("Text").GetComponent<TMP_Text>().color = new Color32(194, 194, 194, 255);
                }
            }
